...
about = gsub('_DATE_', plot_data$get_date[1], readLines('data/about.txt'))
    ...
    fluidPage(
      fluidRow(
        ...
        column(3,
          ...
          selectInput('color', 'Color by', c('Region' = 'region', 'Income level' = 'income_level')),
...
server = function(input, output) {
  ...
  output$description = renderText({
    descriptions$indicator_desc[descriptions$short_name == input$indicator]
  })
